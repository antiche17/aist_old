...
def test_finance_org(order_app):
    ...
    with allure.step("2. Тип в пустой форме"):
        check.is_true(order_app["type_transfer"], "❌ ФР: Тип в пустой форме пустое поле")

    with allure.step("3. Поле От в пустой форме"):
        check.is_true(order_app["ot_org"], "❌ ФР: Поле От в пустой форме пустое поле")

    with allure.step("4. Поле Не вычислять в пустой форме"):
        check.is_true(order_app["no_sum"], "❌ ФР: Поле Не вычислять в пустой форме не выбрано")

    with allure.step("5. Исх. счет Поле Исх. сумма в пустой форме"):
        check.equal(order_app["in_sum_1"], "0", "❌ ФР: Исх. счет Поле Завершен в пустой форме не 0")

    with allure.step("6. Исх. счет Поле Валюта в пустой форме"):
        check.equal(order_app["currency_org1"], "0", "❌ ФР: Исх. счет Поле Завершен в пустой форме не 0")

    with allure.step("7. Исх. счет Поле Валюта не активна в пустой форме"):
        check.is_true(order_app["currency_org1_readonly"], "❌ ФР: Исх. счет Поле Завершен в пустой форме активно")

    with allure.step("8. Вх. счет Поле Валюта не активна в пустой форме"):
        check.is_true(order_app["currency_org2_readonly"], "❌ ФР: Вх. счет Поле Завершен в пустой форме активно")

    with allure.step("9. Итого Исх Валюта в пустой форме"):
        check.equal(order_app["currency_org6"], "0", "❌ ФР: Итого Исх Валюта в пустой форме не 0")

    with allure.step("10. Итого Вх Валюта в пустой форме"):
        check.equal(order_app["currency_org7"], "0", "❌ ФР: Итого Вх Валюта в пустой форме не 0")

    with allure.step("11. Исх комиссия Валюта в пустой форме"):
        check.equal(order_app["currency_org3"], "0", "❌ ФР: Исх комиссия Валюта в пустой форме не 0")

    with allure.step("12. Вх. счет Поле Валюта в пустой форме"):
        check.equal(order_app["currency_org2"], "0", "❌ ФР: Исх комиссия Валюта в пустой форме не 0")

    steps_to_check = [

        ("13. Поле Исполнение в пустой форме", ["execution_in_days"]),
        ("14. Поле Завершен в пустой форме", ["completed_org"]),
        ("15. Поле Вх-формула в пустой форме", ["formula_sum1_selected"]),
        ("16. Поле Исх-формула в пустой форме", ["formula_sum2_selected"]),
        ("17. Исх. счет Поле Со счета: в пустой форме", ["from_check_1"]),
        ("18. Вх. счет Поле Со счета в пустой форме", ["on_check_2"]),
        ("19. Вх. счет Поле Исх. сумма в пустой форме", ["in_sum_2"]),
        ("20. Исх комиссия Дата:", ["date_org1"]),
        ("21. Исх комиссия Комиссия:", ["commission1"]),
        ("22. Исх комиссия Со счета:", ["from_check3"]),
        ("23. Вх комиссия Дата:", ["date_org2"]),
        ("24. Вх комиссия Комиссия:", ["commission2"]),
        ("25. Вх комиссия Валюта:", ["currency_org4"]),
        ("26. Примечание", ["gtd_note"]),
    ]
    ...
    with allure.step("54. Сравнение Валюта с связанном ИС"):
    ...
    with allure.step("55. Сравнение Сумма с связанном ИС"):
    ...
    with allure.step("56. Сравнение Информация с связанном ИС"):
    ...
    with allure.step("57. Сравнение Закрыто с связанном ИС"):
    ...
    with allure.step("58. Сравнение Незакрыто с связанном ИС"):
    ...
    with allure.step("59. Сравнение Начислено с связанном ИС"):
    ...
    with allure.step("60. Сравнение Начислено (С.В.) с связанном ИС"):
    ...
    with allure.step("60. Сравнение Клиент с связаном ВС"):
    ...
    with allure.step("60. Сравнение Покупатель с связаном ВС"):
    ...
    with allure.step("60. Сравнение Поставщик с связаном ВС"):
    ...
    with allure.step("60. Сравнение Валюта с связаном ВС"):
    ...
    with allure.step("60. Сравнение Сумма с связаном ВС"):
    ...
    with allure.step("60. Сравнение Информация с связаном ВС"):
