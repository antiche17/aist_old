...
class WinAISTApp:
    ...
    def finance_ip(self):
        ...
        self.fun.order_data = {
            ...
            'ip_txt': self.fun.get_element_property_sp(main_window, self.fun.loc.TXTTOTAL, "Value"),
        }
        self.fun.click_element_sp(main_window, self.loc.CODE_PAYMENT)
        keyboard.send_keys('1000')
        ...
        self.fun.order_data.update({
            ...
            'ip_code_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.CODE_PAYMENT, "Value"),
            ...
            'ip_txt_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.TXTTOTAL, "Value"),
        })
        ...
        self.fun.click_element_sp(main_window, self.loc.ADD_SERVICES)
        time.sleep(2)
        if self.fun.is_element_present(main_window, self.loc.YES_BUTTON, timeout=2):
            self.fun.click_element(main_window, self.loc.YES_BUTTON, timeout=2)
        else:
            print("YES_BUTTON не найден")
        time.sleep(2)
        self.fun.click_element(main_window, self.loc.EXPAND, timeout=1)
        self.fun.order_data.update({
            'created_vs': self.fun.get_element_property_sp(main_window, self.fun.loc.CREATED_LINE1, "Value"),
        ...
        self.fun.order_data.update({
            ...
            'ip_table_note': self.fun.get_element_property_sp(main_window, self.fun.loc.NOTE_LINE1, "Value"),
    ...
    def finance_vs(self):
        ...
        self.fun.order_data = {
            'vs_number': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_NUMBER,"Value"),
            'vs_list': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_LIST,"Value"),
            'vs_date': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_DATE,"Value"),
            'vs_note': self.fun.get_element_property_sp(main_window, self.fun.loc.NOTE_SERVICES,"Value"),
            'vs_date_sf': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_DATE_SF1, "Value"),

            'vs_supplier': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_SUPPLIER, "Value"),
            'vs_buyer': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_BUYER, "Value"),
            'vs_contractor': self.fun.get_element_property_sp(main_window, self.fun.loc.VS_CONTRACTOR, "Value"),
            'vs_number_order': self.fun.get_element_property_sp(main_window, self.fun.loc.GTD_ORDER, "Value"), #добавить в проверку

            'vs_ocean_vessel': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_VESSEL_PANEL, "Value"),
            'vs_feeder_vessel': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_VESSEL_PANEL, "Value"),
            'vs_ocean_ship': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_SHIP_PANEL, "Value"),
            'vs_feeder_ship': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_SHIP_PANEL, "Value"),
            'vs_arrival': self.fun.get_element_property_sp(main_window, self.fun.loc.ARRIVAL_PANEL, "Value"),
            'vs_shipment': self.fun.get_element_property_sp(main_window, self.fun.loc.SHIPMENT_PANEL, "Value"),
            'vs_loading_conditions': self.fun.get_element_property_sp(main_window, self.fun.loc.LOADING_CONDITIONS_PANEL, "Value"),
            'vs_destination_conditions': self.fun.get_element_property_sp(main_window, self.fun.loc.DESTINATION_CONDITIONS_PANEL, "Value"),
            'vs_terminal': self.fun.get_element_property_sp(main_window, self.fun.loc.TERMINAL_PANEL, "Value"),
            'vs_ocean_line': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_LINE_PANEL, "Value"),
            'vs_feeder_line': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_LINE_PANEL, "Value"),
            'vs_loading_location': self.fun.get_element_property_sp(main_window, self.fun.loc.LOADING_LOCATION_PANEL, "Value"),
            'vs_destination': self.fun.get_element_property_sp(main_window, self.fun.loc.DESTINATION_PANEL, "Value"),

            'vs_return_date': self.fun.get_element_property_sp(main_window, self.fun.loc.RETURN_DATE_PANEL, "Value"),
            'vs_pickup_date': self.fun.get_element_property_sp(main_window, self.fun.loc.PICKUP_DATE_PANEL, "Value"),
            'vs_gtd': self.fun.get_element_property_sp(main_window, self.fun.loc.GTD_PANEL, "Value"),
        }
        self.fun.click_element(main_window, self.loc.EXPAND, timeout=1)
        ...
        self.fun.click_element_sp(main_window, self.loc.IS_FREIGHT)
        self.fun.set_text_field(main_window, self.fun.loc.NOTE_SERVICES, "Примечание для ИС", timeout=1)
        self.fun.click_element(main_window, self.fun.loc.IS_DATE_SF1, timeout=1)
        keyboard.send_keys('1')
        self.fun.click_element_sp(main_window, self.loc.IS_SUPPLIER)
        self.fun.set_text_field(main_window, self.fun.loc.SEARCH_BOX, "бодрус", timeout=1)
        time.sleep(1)
        self.fun.click_element_sp(main_window, self.loc.RECIPIENT_4)
        self.fun.click_element_sp(main_window, self.loc.VS_CONTRACTOR)
        self.fun.set_text_field(main_window, self.fun.loc.SEARCH_BOX, "Веспа", timeout=1)
        time.sleep(1)
        self.fun.click_element_sp(main_window, self.loc.RECIPIENT_1)
        self.fun.click_element_sp(main_window, self.loc.IS_BUYER)
        ...
        self.fun.click_element_sp(main_window, self.loc.LOADING_LOCATION_PANEL)
        keyboard.send_keys('Китай')
        self.fun.click_element_sp(main_window, self.loc.TERMINAL_PANEL)
        time.sleep(1)
        self.fun.click_element_sp(main_window, self.loc.RECIPIENT_2)

        self.fun.click_element_sp(main_window, self.loc.DESTINATION_PANEL)
        keyboard.send_keys('Россия')
        self.fun.click_element_sp(main_window, self.loc.SHIPMENT_PANEL)
        keyboard.send_keys('2')
        self.fun.click_element_sp(main_window, self.loc.ARRIVAL_PANEL)
        keyboard.send_keys('3')
        ...
        time.sleep(2)
        self.fun.order_data.update({
            'vs_number_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_NUMBER, "Value"),
            'vs_list_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_LIST, "Value"),
            'vs_date_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_DATE, "Value"),
            'vs_note_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.NOTE_SERVICES, "Value"),
            'vs_date_sf_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_DATE_SF1, "Value"),

            'vs_supplier_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_SUPPLIER, "Value"),
            'vs_buyer_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_BUYER, "Value"),
            'vs_contractor_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.VS_CONTRACTOR, "Value"),
            'vs_number_order_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.GTD_ORDER, "Value"),
            'vs_ocean_vessel_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_VESSEL_PANEL,
                                                                    "Value"),
            'vs_feeder_vessel_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_VESSEL_PANEL,
                                                                     "Value"),
            'vs_ocean_ship_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_SHIP_PANEL, "Value"),
            'vs_feeder_ship_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_SHIP_PANEL,
                                                                   "Value"),
            'vs_arrival_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.ARRIVAL_PANEL, "Value"),
            'vs_shipment_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.SHIPMENT_PANEL, "Value"),
            'vs_loading_conditions_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.LOADING_CONDITIONS_PANEL,
                                                                          "Value"),
            'vs_destination_conditions_mod': self.fun.get_element_property_sp(main_window,self.fun.loc.DESTINATION_CONDITIONS_PANEL,"Value"),
            'vs_terminal_mod': self.fun.get_element_property(main_window, self.fun.loc.TERMINAL_PANEL, "Value"),
            'vs_ocean_line_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.OCEAN_LINE_PANEL, "Value"),
            'vs_feeder_line_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.FEEDER_LINE_PANEL,
                                                                   "Value"),
            'vs_loading_location_mod': self.fun.get_element_property_sp(main_window,
                                                                        self.fun.loc.LOADING_LOCATION_PANEL,
                                                                        "Value"),
            'vs_destination_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.DESTINATION_PANEL,
                                                                   "Value"),
            'vs_return_date_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.RETURN_DATE_PANEL,
                                                                   "Value"),
            'vs_pickup_date_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.PICKUP_DATE_PANEL,
                                                                   "Value"),
            'vs_gtd_mod': self.fun.get_element_property_sp(main_window, self.fun.loc.GTD_PANEL, "Value"),
        })
        text = self.fun.get_element_value(main_window, self.loc.IS_NUMBER, timeout=1)
        ...
        # Связываем с Исх. переводы
        self.fun.click_element_sp(main_window, self.loc.INCOMING_TRANSFERS2)
        self.fun.click_element_sp(main_window, self.loc.CONNECT_TRANSFERS1)
        time.sleep(2)
        self.fun.click_element_sp(main_window, self.loc.SERVICES_OPTIONS)
        keyboard.send_keys('{DOWN}')
        keyboard.send_keys('{ENTER}')
        ...
        self.fun.order_data.update({
            ...
            'service_currency_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1, "Value"),
            'service_amount_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'service_unallocated_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.UNALLOCATED_LINE1,
                                                                       "Value"),
            'service_note_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.NOTE_LINE1, "Value"),
            'service_info_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.INFO_LINE1, "Value"),
            'service_closed_vp': self.fun.get_element_property_sp(main_window, self.fun.loc.CLOSED_LINE1, "Value"),
        ...
        self.fun.order_data.update({
            'service_is_payment_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_PAYMENT_LINE1,
                                                                           "Value"),
            'service_date_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.DATE_LINE1, "Value"),
            'service_is_type_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.IS_TYPE_LINE1,
                                                                        "Value"),
            'service_supplier_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.SUPPLIER_LINE1,
                                                                         "Value"),
            'service_invoice_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.INVOICE_LINE1,
                                                                        "Value"),
            'service_client_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CLIENT_LINE1, "Value"),
            'service_contractor_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CONTRACTOR_LINE1,
                                                                           "Value"),
            'service_buyer_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.BUYER_LINE1, "Value"),
            'service_currency_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1,
                                                                         "Value"),
            'service_amount_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'service_unallocated_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.UNALLOCATED_LINE1,
                                                                            "Value"),
            ...
            'service_closed_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CLOSED_LINE1, "Value"),
            'service_unpaid_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.UNPAID_LINE1, "Value"),
            'service_charged_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_LINE1,
                                                                        "Value"),
            'service_charged_sv_vp_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_SV_LINE1,
                                                                           "Value"),
        ...
        self.fun.order_data.update({
            'service_date_is': self.fun.get_element_property_sp(main_window, self.fun.loc.DATE_LINE1, "Value"),
            'account_is': self.fun.get_element_property_sp(main_window, self.fun.loc.ACCOUNT_LINE1, "Value"),
            'currency_is': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1, "Value"),
            'amount_is': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'client_is': self.fun.get_element_property_sp(main_window, self.fun.loc.CLIENT_LINE1, "Value"),
        })

        self.fun.click_element_sp(main_window, self.loc.OK_BUTTON1)
        self.fun.order_data.update({
            'service_date_is_form': self.fun.get_element_property_sp(main_window, self.fun.loc.DATE_LINE1, "Value"),
            'account_is_form': self.fun.get_element_property_sp(main_window, self.fun.loc.ACCOUNT_LINE1, "Value"),
            'currency_is_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1, "Value"),
            'amount_is_form': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'client_is_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CLIENT_LINE1, "Value"),
        })
        time.sleep(1)

        # Взаимозачеты с исх. счетами
        self.fun.click_element_sp(main_window, self.loc.OFF_OUTGOING_ACCOUNTS)
        self.fun.click_element_sp(main_window, self.loc.CONNECT_IS)
        time.sleep(2)
        self.fun.click_element(main_window, self.loc.RECIPIENT_1, timeout=1)
        time.sleep(1)
        self.fun.click_element(main_window, self.loc.ADD_SERVICES, timeout=1)
        ...
        time.sleep(1)
        self.fun.order_data.update({
            'date_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.DATE_LINE1, "Value"),
            'account_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.ACCOUNT_LINE1, "Value"),
            'currency_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1, "Value"),
            'amount_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'info_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.INFO_LINE1, "Value"),
            'closed_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.CLOSED_LINE1, "Value"),
            'unpaid_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.UNPAID_LINE1, "Value"),
            'charged_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_LINE1, "Value"),
            'charged_sv_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_SV_LINE1, "Value"),
            'buyer_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.BUYER_LINE1, "Value"),
            'supplier_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.SUPPLIER_LINE1, "Value"),
            'client_vis': self.fun.get_element_property_sp(main_window, self.fun.loc.CLIENT_LINE1, "Value"),
        })
        self.fun.click_element_sp(main_window, self.loc.OK_BUTTON1)
        time.sleep(1)
        self.fun.order_data.update({
            'date_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.DATE_LINE1, "Value"),
            'account_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.ACCOUNT_LINE1, "Value"),
            'currency_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CURRENCY_LINE1, "Value"),
            'amount_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.AMOUNT_LINE1, "Value"),
            'info_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.INFO_LINE1, "Value"),
            'closed_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CLOSED_LINE1, "Value"),
            'unpaid_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.UNPAID_LINE1, "Value"),
            'charged_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_LINE1, "Value"),
            'charged_sv_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CHARGED_SV_LINE1,
                                                                    "Value"),
            'buyer_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.BUYER_LINE1, "Value"),
            'supplier_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.SUPPLIER_LINE1, "Value"),
            'client_vis_form': self.fun.get_element_property_sp(main_window, self.fun.loc.CLIENT_LINE1, "Value"),
        })
        self.fun.click_element_sp(main_window, self.loc.APPLY_BUTTON)
        self.fun.click_element(main_window, self.loc.OK_BUTTON, timeout=1)
        self.fun.click_element_sp(main_window, self.loc.FILES)
