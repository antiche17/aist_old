...
class WinAISTApp:
    ...
    def transport_auto(self):
        ...
        self.fun.order_data.update({
            'auto_order_number': self.fun.get_element_property(main_window, self.fun.loc.AUTO_NAME_TRANSPORTATION, "Value"),
            ...
            'auto_create_date': self.fun.get_element_property(main_window, self.fun.loc.CREATE_DATE, "Name"),
            'auto_mode_date': self.fun.get_element_property(main_window, self.fun.loc.MOD_DATE, "Name"),
            'auto_finish_date': self.fun.get_element_property(main_window, self.fun.loc.COMPLETION_DATE, "Name"),
            ...
            'auto_note': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })
        time.sleep(1)
        ...
        self.fun.order_data.update({
            ...
            'auto_priority_mod': self.fun.get_element_property(main_window, self.fun.loc.PRIORITY_COMBO, "Value"),
            'auto_otv_mod': self.fun.get_element_property(main_window, self.fun.loc.RESPONSIBLE_COMBO, "Value"),

            'auto_type_freight_mod': self.fun.get_element_property(main_window, self.fun.loc.TYPE_FREIGHT, "Value"),
            'auto_class_freight_mod': self.fun.get_element_property(main_window, self.fun.loc.CLASS_FREIGHT_AUTO, "Value"),
            'auto_download_method_mod': self.fun.get_element_property(main_window, self.fun.loc.DOWNLOAD_METHOD_AUTO, "Value"),
            'auto_ref_freight_mod': self.fun.get_element_property(main_window, self.fun.loc.REFERENCE_FREIGHT, "Value"),

            'auto_mode_date_mod': self.fun.get_element_property(main_window, self.fun.loc.MOD_DATE, "Name"),
            'auto_finish_date_mod': self.fun.get_element_property(main_window, self.fun.loc.COMPLETION_DATE, "Name"),

            'auto_carrier_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_CARRIER, "Value"),
            'auto_cmr_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_CMR, "Value"),
            'auto_cmr_por_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_CMR_POR, "Value"),

            'auto_note_mod': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })

        self.fun.click_element_sp(main_window, self.fun.loc.TAB_ROUTES)

        # 8. Создание всех маршрутов
        ...
        # 12. Адрес добавить
        self.fun.click_element(main_window, self.loc.ADDRESS1, timeout=1)
        ...
        self.fun.order_data.update({
            ...
            'driver1': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE1, "Value"),
            'driver2': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE2, "Value"),
            'driver3': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE3, "Value"),
            'plan_load1': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD1, "Value"),
            'plan_load2': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD2, "Value"),
            'plan_load3': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD3, "Value"),
            'fact_load1': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD1, "Value"),
            'fact_load2': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD2, "Value"),
            'fact_load3': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD3, "Value"),
            'car1': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE1, "Value"),
            'car2': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE2, "Value"),
            'car3': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE3, "Value"),
            'plan_arrival1': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA1, "Value"),
            'plan_arrival2': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA2, "Value"),
            'plan_arrival3': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA3, "Value"),
            'fact_arrival1': self.fun.get_element_property(main_window, self.fun.loc.FACT_ARRIVAL_DATA1, "Value"),
        ...
        time.sleep(1)
        self.fun.order_data.update({
            'shipment_name': self.fun.get_element_property(main_window, self.fun.loc.AUTO_NAME_TRANSPORTATION, "Value"),
            'shipment_address': self.fun.get_element_property(main_window, self.fun.loc.AUTO_ADDRESS, "Value"),
            'shipment_driver': self.fun.get_element_property(main_window, self.fun.loc.AUTO_DRIVER, "Value"),
            'shipment_auto': self.fun.get_element_property(main_window, self.fun.loc.AUTO_FORM1, "Value"),
            'shipment_plan_data': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT_DATA1, "Value"),
            'shipment_fact_data': self.fun.get_element_property(main_window, self.fun.loc.PREFORWARDING_FACT_DATA, "Value"),
            'shipment_note': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })
        self.fun.click_element_sp(main_window, self.loc.AUTO_ADDRESS)
        self.fun.click_element_double_sp(main_window, self.fun.loc.RECIPIENT_7)
        ...
        self.fun.click_element_sp(main_window, self.fun.loc.APPLY_BUTTON1)
        self.fun.order_data.update({
            'shipment_address_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_ADDRESS, "Value"),
            'shipment_driver_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_DRIVER, "Value"),
            'shipment_auto_mod': self.fun.get_element_property(main_window, self.fun.loc.AUTO_FORM1, "Value"),
            'shipment_plan_data_mod': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT_DATA1, "Value"),
            'shipment_fact_data_mod': self.fun.get_element_property(main_window, self.fun.loc.PREFORWARDING_FACT_DATA, "Value"),
            'shipment_note_mod': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })
        ...
        time.sleep(1)
        self.fun.order_data.update({
            #'arrival_name': self.fun.get_element_property(main_window, self.fun.loc.AUTO_NAME_TRANSPORTATION, "Value"),
            'arrival_address': self.fun.get_element_property(main_window, self.fun.loc.AUTO_ADDRESS, "Value"),
            'arrival_plan_data': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA1, "Value"),
            'arrival_fact_data': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA_FACT, "Value"),
        ...
        self.fun.order_data.update({
            ...
            'arrival_fact_data_mod': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA_FACT, "Value"),
        ...
        self.fun.order_data.update({
            #'shipment3': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT3, "Value"),
            'drop_con_address': self.fun.get_element_property(main_window, self.fun.loc.TERMINAL_CHANGE, "Value"),
            'drop_con_plan_data': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA1, "Value"),
            'drop_con_fact_data': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA_FACT, "Value"),
            'drop_con_note': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })
        ...
        self.fun.click_element_sp(main_window, self.fun.loc.APPLY_BUTTON1)
        self.fun.order_data.update({
            'drop_con_address_mod': self.fun.get_element_property(main_window, self.fun.loc.TERMINAL_CHANGE, "Value"),
            'drop_con_plan_data_mod': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA1, "Value"),
            'drop_con_fact_data_mod': self.fun.get_element_property(main_window, self.fun.loc.ARRIVAL_DATA_FACT, "Value"),
            'drop_con_note_mod': self.fun.get_element_property(main_window, self.fun.loc.NOTE, "Value"),
        })
        self.fun.click_element_sp(main_window, self.fun.loc.SAVE_BUTTON)
        main_window = self.fun.get_auto_form()
        main_window.set_focus()
        ...
        self.fun.order_data.update({
            'shipment1_mod': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT1, "Value"),
            'shipment2_mod': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT2, "Value"),
            'shipment3_mod': self.fun.get_element_property(main_window, self.fun.loc.SHIPMENT3, "Value"),
            'address1_mod': self.fun.get_element_property(main_window, self.fun.loc.ADDRESS_TABLE1, "Value"),
            'address2_mod': self.fun.get_element_property(main_window, self.fun.loc.ADDRESS_TABLE2, "Value"),
            'address3_mod': self.fun.get_element_property(main_window, self.fun.loc.ADDRESS_TABLE3, "Value"),
            'driver1_mod': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE1, "Value"),
            'driver2_mod': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE2, "Value"),
            'driver3_mod': self.fun.get_element_property(main_window, self.fun.loc.DRIVER_TABLE3, "Value"),
            'plan_load1_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD1, "Value"),
            'plan_load2_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD2, "Value"),
            'plan_load3_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_LOAD3, "Value"),
            'fact_load1_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD1, "Value"),
            'fact_load2_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD2, "Value"),
            'fact_load3_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_LOAD3, "Value"),
            'car1_mod': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE1, "Value"),
            'car2_mod': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE2, "Value"),
            'car3_mod': self.fun.get_element_property(main_window, self.fun.loc.CAR_TABLE3, "Value"),
            'plan_arrival1_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA1, "Value"),
            'plan_arrival2_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA2, "Value"),
            'plan_arrival3_mod': self.fun.get_element_property(main_window, self.fun.loc.PLAN_ARRIVAL_DATA3, "Value"),
            'fact_arrival1_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_ARRIVAL_DATA1, "Value"),
            'fact_arrival2_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_ARRIVAL_DATA2, "Value"),
            'fact_arrival3_mod': self.fun.get_element_property(main_window, self.fun.loc.FACT_ARRIVAL_DATA3, "Value"),
        })
        self.fun.click_element_sp(main_window, self.fun.loc.SAVE_BUTTON)
        ...
        self.fun.order_data.update({
            ...
            'status_table1': self.fun.get_element_property_sp(main_window, self.fun.loc.STATUS_TABLE1, "Value"),
            'priority_table1': self.fun.get_element_property_sp(main_window, self.fun.loc.PRIORITY_TABLE1, "Value"),
